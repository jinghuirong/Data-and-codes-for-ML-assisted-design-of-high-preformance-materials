...
param_grid=[{'max_depth':range(2,8,1),'min_samples_leaf':range(2,6,1),'n_estimators':range(100,300,50)
            }]
RFR=ensemble.RandomForestRegressor(random_state=42)
kf=KFold(n_splits=5,shuffle=True,random_state=0)
grid_search=GridSearchCV(RFR,param_grid,cv=kf,scoring='neg_mean_absolute_error')
